  ...
  it('can update', () => {
    return request(baseUrl)
      ...
      .expect(async ({ body }) => {
        ...
        expect(body.data.detail.education).toEqual(updateData.education);
        expect(body.data.detail.height).toEqual(updateData.height);
      });
  });
});
